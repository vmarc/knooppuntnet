...
class RawCodec(registry: CodecRegistry) extends Codec[Raw] {
  ...
  override def decode(bsonReader: BsonReader, decoderContext: DecoderContext): Raw = {
    ...
    while (bsonReader.readBsonType != BsonType.END_OF_DOCUMENT) {
      ...
      if (fieldName == "version") {
        ...
        Codecs.warn(s"Unknown field name: $fieldName in RawCodec.decode()")
  ...
  override def encode(bsonWriter: BsonWriter, value: Raw, encoderContext: EncoderContext): Unit = {
  ...
  override def getEncoderClass: Class[Raw] = {
    classOf[Raw]
  }
}
