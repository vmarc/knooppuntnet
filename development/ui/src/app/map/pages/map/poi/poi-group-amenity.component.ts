...
@Component({
  ...
  template: `
    <kpn-poi-group name="Amenity" i18n-name="@@poi.group.amenity">
      ...
      <kpn-poi-config poiId="bicycle_parking"></kpn-poi-config>
      <kpn-poi-config poiId="bicycle_rental"></kpn-poi-config>
      ...
      <kpn-poi-config poiId="music_school"></kpn-poi-config>
      ...
      <kpn-poi-config poiId="post_box"></kpn-poi-config>
      <kpn-poi-config poiId="post_office"></kpn-poi-config>
      ...
      <kpn-poi-config poiId="place_of_worship"></kpn-poi-config>
      <kpn-poi-config poiId="church"></kpn-poi-config>
      <kpn-poi-config poiId="mosque"></kpn-poi-config>
      <kpn-poi-config poiId="buddhist_temple"></kpn-poi-config>
      <kpn-poi-config poiId="hindu_temple"></kpn-poi-config>
