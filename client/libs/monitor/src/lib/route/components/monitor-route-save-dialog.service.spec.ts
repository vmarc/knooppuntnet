...
describe('monitor route save dialog', () => {
  ...
  it('update route with reference type gpx, including gpx reference update', () => {
    class Mock extends MonitorRouteServiceMock {
  ...
  it('update route with reference type gpx, without gpx reference update', () => {
    class Mock extends MonitorRouteServiceMock {
      override routeUpdate(
        groupName: string,
        name: string,
  ...
  it('update route with reference type osm', () => {
    class Mock extends MonitorRouteServiceMock {
      override routeUpdate(
        groupName: string,
        name: string,
  ...
  it('update route with reference type multi-gpx', () => {
    class Mock extends MonitorRouteServiceMock {
      override routeUpdate(
        groupName: string,
        name: string,
