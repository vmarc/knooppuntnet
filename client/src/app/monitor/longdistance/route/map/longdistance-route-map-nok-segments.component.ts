    ...
    <ng-template #gpxTrace>
      ...
      <div class="segment segment-header">
        <span class="segment-id">
          <kpn-longdistance-route-map-legend-line color="red"></kpn-longdistance-route-map-legend-line>
        </span>
...
export class LongdistanceRouteMapNokSegmentsComponent {
  ...
  readonly gpxTraceAvailable$ = this.store.select(selectLongdistanceRouteMapGpxEnabled);
