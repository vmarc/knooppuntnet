  ...
  template: `
    ...
    <div *ngIf="response$ | async as response" class="kpn-spacer-above">
      ...
      <div *ngIf="response.result">
        ...
        <kpn-items>
          <kpn-item
            *ngFor="let changeSet of changes$ | async; let i = index"
            [index]="i"
          >
            <div class="change-set">
              ...
              <div>
                <p>Reference: {{ changeSet.gpxFilename }}</p>
                <table>
                  <tr>
                    <td>GPX</td>
                ...
                <p>
                  ways={{ changeSet.wayCount }}, added={{
                    changeSet.waysAdded
                  }}, removed={{ changeSet.waysRemoved }}, updated={{
                    changeSet.waysUpdated
                  }}
                </p>
                ...
                <p
                  *ngIf="changeSet.resolvedNokSegmentCount > 0"
                  class="kpn-line"
                >
                  <span
                    >Resolved deviations:
                    {{ changeSet.resolvedNokSegmentCount }}</span
                  >
                  <kpn-icon-happy></kpn-icon-happy>
                </p>
                <p *ngIf="changeSet.newNokSegmentCount > 0" class="kpn-line">
                  <span
                    >New deviations: {{ changeSet.newNokSegmentCount }}</span
                  >
