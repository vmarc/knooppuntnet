      ...
      <table mat-table [dataSource]="dataSource">
        <ng-container matColumnDef="id">
          ...
          <td mat-cell *matCellDef="let route">
            <a [routerLink]="'/monitor/long-distance-routes/' + route.id">{{
              route.id
            }}</a>
          </td>
        </ng-container>
        ...
        <ng-container matColumnDef="distance">
          ...
          <td mat-cell *matCellDef="let route">{{ route.osmDistance }}km</td>
        </ng-container>
...
export class LongdistanceRoutesTableComponent implements OnInit {
  readonly dataSource: MatTableDataSource<LongdistanceRouteDetail> =
    new MatTableDataSource();

  readonly response$: Observable<ApiResponse<LongdistanceRoutesPage>> =
    this.store.pipe(
