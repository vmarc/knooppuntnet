  ...
  public static fromJSON(jsonObject: any): NodeChangeInfo {
    ...
    return new NodeChangeInfo(
      ...
      jsonObject.connectionChanges
        ...
        : List(),
      jsonObject.roleConnectionChanges
        ? List(
        ...
        : List(),
      jsonObject.definedInNetworkChanges
        ? List(
      ...
      jsonObject.addedToRoute
        ? List(jsonObject.addedToRoute.map((json: any) => Ref.fromJSON(json)))
        : List(),
      jsonObject.removedFromRoute
        ? List(
            jsonObject.removedFromRoute.map((json: any) => Ref.fromJSON(json))
          )
        : List(),
      jsonObject.addedToNetwork
        ? List(jsonObject.addedToNetwork.map((json: any) => Ref.fromJSON(json)))
        : List(),
      jsonObject.removedFromNetwork
        ? List(
