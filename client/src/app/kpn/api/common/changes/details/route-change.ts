...
export class RouteChange {
  ...
  public static fromJSON(jsonObject: any): RouteChange {
    ...
    return new RouteChange(
      ...
      jsonObject.removedWays
        ? List(jsonObject.removedWays.map((json: any) => RawWay.fromJSON(json)))
        : List(),
      jsonObject.addedWays
        ? List(jsonObject.addedWays.map((json: any) => RawWay.fromJSON(json)))
        : List(),
      jsonObject.updatedWays
        ? List(
