...
export class SurveyDateFilter<T> extends Filter<T> {
  ...
  filterOptions(allFilters: Filters<T>, elements: List<T>): FilterOptionGroup {
    ...
    const lastMonthCount = filteredElements.count((e) =>
      this.sameAsOrYoungerThan(e, this.surveyDateInfo.lastMonthStart)
    );
    const lastHalfYearCount = filteredElements.count((e) =>
      this.isBetween(
        e,
        this.surveyDateInfo.lastMonthStart,
        this.surveyDateInfo.lastHalfYearStart
    ...
    const lastYearCount = filteredElements.count((e) =>
      this.isBetween(
        e,
        this.surveyDateInfo.lastHalfYearStart,
        this.surveyDateInfo.lastYearStart
    ...
    const lastTwoYearsCount = filteredElements.count((e) =>
      this.isBetween(
        e,
        this.surveyDateInfo.lastYearStart,
        this.surveyDateInfo.lastTwoYearsStart
    ...
    const olderCount = filteredElements.count(
      (e) =>
        !!this.getter(e) &&
        this.getter(e).olderThan(this.surveyDateInfo.lastTwoYearsStart)
    );
