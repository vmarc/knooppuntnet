...
@Component({
  selector: 'kpn-long-distance-route-change-map',
...
export class LongDistanceRouteChangeMapComponent implements AfterViewInit, OnDestroy {

  @Input() mapId: string;
  @Input() referenceJson: string;
  @Input() routeSegments: LongDistanceRouteSegment[];
  @Input() nokSegment: LongDistanceRouteNokSegment;
