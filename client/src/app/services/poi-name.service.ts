export class PoiNameService {
  ...
  xxx() {
    ...
    keysAndValues.push(['american-football', $localize`:@@poi.american-football:American football`]);
    keysAndValues.push(['apartment', $localize`:@@poi.apartment:Apartment`]);
    keysAndValues.push(['arts-centre', $localize`:@@poi.arts-centre:Arts centre`]);
    ...
    keysAndValues.push(['bicycle-parking', $localize`:@@poi.bicycle-parking:Bicycle parking`]);
    keysAndValues.push(['bicycle-rental', $localize`:@@poi.bicycle-rental:Bicycle rental`]);
    keysAndValues.push(['bicycle-rental-2', $localize`:@@poi.bicycle-rental:Bicycle rental`]);
    keysAndValues.push(['biergarten', $localize`:@@poi.biergarten:Biergarten`]);
    keysAndValues.push(['books-stationary', $localize`:@@poi.books-stationary:Books/stationary`]);
    keysAndValues.push(['boundary-stone', $localize`:@@poi.boundary-stone:Boundary stone`]);
    keysAndValues.push(['buddhist-temple', $localize`:@@poi.buddhist-temple:Buddhist temple`]);
    ...
    keysAndValues.push(['confectionery', $localize`:@@poi.confectionery:Confectionery`]);
    ...
    keysAndValues.push(['defibrillator', $localize`:@@poi.defibrillator:Defibrillator`]);
    keysAndValues.push(['deli', $localize`:@@poi.deli:Deli`]);
    keysAndValues.push(['departmentstore', $localize`:@@poi.departmentstore:Department store`]);
    keysAndValues.push(['diy-hardware', $localize`:@@poi.diy-hardware:DIY hardware`]);
    keysAndValues.push(['drinking-water', $localize`:@@poi.drinking-water:Drinking water`]);
    keysAndValues.push(['ebike-charging', $localize`:@@poi.ebike-charging:Ebike charging`]);
    keysAndValues.push(['embassy', $localize`:@@poi.embassy:Embassy`]);
    keysAndValues.push(['fastfood', $localize`:@@poi.fastfood:Fast food`]);
    keysAndValues.push(['firestation', $localize`:@@poi.firestation:Firestation`]);
    ...
    keysAndValues.push(['garden-centre', $localize`:@@poi.garden-centre:Garden centre`]);
    ...
    keysAndValues.push(['guesthouse', $localize`:@@poi.guesthouse:Guest house`]);
    keysAndValues.push(['gymnastics', $localize`:@@poi.gymnastics:Gymnastics`]);
    keysAndValues.push(['hairdresser', $localize`:@@poi.hairdresser:Hairdresser`]);
    keysAndValues.push(['heritage', $localize`:@@poi.heritage:Heritage`]);
    keysAndValues.push(['hindu-temple', $localize`:@@poi.hindu-temple:Hindu temple`]);
    keysAndValues.push(['historic', $localize`:@@poi.historic:Historic`]);
    keysAndValues.push(['hockey', $localize`:@@poi.hockey:Hockey`]);
    keysAndValues.push(['horseracing', $localize`:@@poi.horseracing:Horse racing`]);
    ...
    keysAndValues.push(['information', $localize`:@@poi.information:Information`]);
    ...
    keysAndValues.push(['marketplace', $localize`:@@poi.marketplace:Marketplace`]);
    keysAndValues.push(['monumental-tree', $localize`:@@poi.monumental-tree:Monumental tree`]);
    keysAndValues.push(['monument-memorial', $localize`:@@poi.monument-memorial:Monument`]);
    ...
    keysAndValues.push(['musical-instrument', $localize`:@@poi.musical-instrument:Musical instrument`]);
    keysAndValues.push(['musicschool', $localize`:@@poi.musicschool:Music school`]);
    ...
    keysAndValues.push(['place-of-worship', $localize`:@@poi.place-of-worship:Place of worship`]);
    keysAndValues.push(['police', $localize`:@@poi.police:Police`]);
    keysAndValues.push(['postbox', $localize`:@@poi.postbox:Post box`]);
    keysAndValues.push(['postoffice', $localize`:@@poi.postoffice:Post office`]);
    ...
    keysAndValues.push(['shoppingcentre', $localize`:@@poi.shoppingcentre:Shopping centre`]);
    keysAndValues.push(['soccer', $localize`:@@poi.soccer:Soccer`]);
    keysAndValues.push(['sportscentre', $localize`:@@poi.sportscentre:Sports centre`]);
    keysAndValues.push(['statue', $localize`:@@poi.statue:Statue`]);
    keysAndValues.push(['supermarket', $localize`:@@poi.supermarket:Supermarket`]);
    ...
    keysAndValues.push(['travelagency', $localize`:@@poi.travelagency:Travelagency`]);
    ...
    keysAndValues.push(['wayside-shrine', $localize`:@@poi.wayside-shrine:Wayside shrine`]);
