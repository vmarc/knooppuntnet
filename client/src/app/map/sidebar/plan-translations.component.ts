...
@Component({
  ...
  template: `
    <div *ngIf="!isRegistryUpdated()">
      ...
      <span id="heading-north-east" i18n="@@plan.heading.north-east"
        >north-east</span
      >
      <span id="heading-east" i18n="@@plan.heading.east">east</span>
      <span id="heading-south-east" i18n="@@plan.heading.south-east"
        >south-east</span
      >
      <span id="heading-south" i18n="@@plan.heading.south">south</span>
      <span id="heading-south-west" i18n="@@plan.heading.south-west"
        >south-west</span
      >
      <span id="heading-west" i18n="@@plan.heading.west">west</span>
      <span id="heading-north-west" i18n="@@plan.heading.north-west"
        >north-west</span
      >

      <span id="command-continue" i18n="@@plan.command.continue">Continue</span>
      <span id="command-turn-slight-left" i18n="@@plan.command.turn-slight-left"
        >Slight left</span
      >
      <span
        id="command-turn-slight-right"
        i18n="@@plan.command.turn-slight-right"
        >Slight right</span
      >
      <span id="command-turn-left" i18n="@@plan.command.turn-left"
        >Turn left</span
      >
      <span id="command-turn-right" i18n="@@plan.command.turn-right"
        >Turn right</span
      >
      <span id="command-turn-sharp-left" i18n="@@plan.command.turn-sharp-left"
        >Sharp left</span
      >
      <span id="command-turn-sharp-right" i18n="@@plan.command.turn-sharp-right"
        >Sharp right</span
      >
