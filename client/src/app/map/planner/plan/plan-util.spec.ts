...
describe("PlanUtil", () => {
  ...
  it("toUrlString - plan with multiple legs", () => {
    ...
    const leg1 = new PlanLeg("", startNode, viaNode1, null, 0, List([route1]));
    const leg2 = new PlanLeg("", viaNode1, viaNode2, null, 0, List([route2]));
    const leg3 = new PlanLeg("", viaNode1, endNode, null, 0, List([route3]));
