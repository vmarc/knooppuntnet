...
describe("PlannerCommandSplitLeg", () => {
  ...
  it("split leg - do and undo", () => {
    ...
    const oldLeg = new PlanLeg("12", node1, node2, null, 0, List());
    const newLeg1 = new PlanLeg("13", node1, node3, null, 0, List());
    const newLeg2 = new PlanLeg("32", node3, node2, null, 0, List());
