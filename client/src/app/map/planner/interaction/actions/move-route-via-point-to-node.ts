...
export class MoveRouteViaPointToNode {
  ...
  viaRouteDragMove(viaRouteDrag: PlannerDragViaRouteFlag, viaNode: PlanNode, oldLeg: PlanLeg): void {
    this.move(viaRouteDrag.oldNode, viaRouteDrag.planFlag, viaNode, oldLeg);
  }

  nodeDragMove(nodeDrag: PlannerDragFlag, viaNode: PlanNode, oldLeg: PlanLeg): void {
    this.move(nodeDrag.oldNode, nodeDrag.planFlag, viaNode, oldLeg);
  }

  private move(oldNode: PlanNode, dragFlag: PlanFlag, viaNode: PlanNode, oldLeg: PlanLeg): void {
