    ...
    <div *ngIf="response$ | async as response" class="kpn-spacer-above">
      ...
      <div *ngIf="response.result as page">
        ...
        <kpn-data title="Relation last updated" i18n-title="@@route.relation-last-updated">
          <kpn-timestamp [timestamp]="page.route.summary.timestamp"></kpn-timestamp>
        </kpn-data>
        ...
        <div *ngIf="page.route.analysis as analysis">
          ...
          <kpn-data title="Start node" i18n-title="@@route.start-node">
            <kpn-route-start-nodes [analysis]="analysis"></kpn-route-start-nodes>
          </kpn-data>
        ...
        <kpn-data title="Location" i18n-title="@@route.location">
          <kpn-route-location [locationAnalysis]="page.route.analysis.locationAnalysis"></kpn-route-location>
        </kpn-data>

        <div *ngIf="page.route.analysis && showRouteDetails$ | async">
          <kpn-data title="Structure" i18n-title="@@route.structure">
            <kpn-route-structure [structureStrings]="page.route.analysis.structureStrings"></kpn-route-structure>
          </kpn-data>
        </div>
