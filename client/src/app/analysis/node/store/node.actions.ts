...
export const actionNodeDetailsPageInit = createAction(
  '[NodeDetailsPage] Init'
);
...
export const actionNodeMapPageInit = createAction(
  '[NodeMapPage] Init'
);
...
export const actionNodeChangesPageInit = createAction(
  '[NodeChangesPage] Init'
);
