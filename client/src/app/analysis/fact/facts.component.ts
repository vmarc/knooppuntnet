...
@Component({
  ...
  template: `
    <div *ngIf="filteredFactInfos.isEmpty()" i18n="@@facts.none">None</div>
...
export class FactsComponent {
  ...
  get filteredFactInfos(): List<FactInfo> {
    return this.factInfos.filterNot(
      (factInfo) => factInfo.fact.name === 'RouteBroken'
    );
  }
