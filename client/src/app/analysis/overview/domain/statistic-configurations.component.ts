  ...
  template: `
    <div *ngIf="!isRegistryUpdated()">
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of routes that are marked as having an incomplete definition.\\ A
        route definition is explicitely marked incomplete by adding a tag
        _"fixme"_ with value _"incomplete"_ in the route relation.
      </kpn-statistic-configuration>
      ...
      >
        ...
        that look ok after analysis.\\ A route definition is explicitely marked
        incomplete by adding a tag _"fixme"_ with value _"incomplete"_ in the
        route relation.
      </kpn-statistic-configuration>
      ...
      >
        Number of network nodes that do not belong to a network.\\ The
        [node](docs/en.html#glossary-node "node in glossary") was not added as a
        member to a valid [network
        relation](docs/en.html#glossary-network-relation "relation in glossary")
        and also not added as a member to a valid [route
        relation](docs/en.html#glossary-route-relation "route relation in
        glossary") (that itself was added as a member to a valid network
        relation or is an orphan route).
      </kpn-statistic-configuration>
      ...
      >
        Number of network routes that do not belong to a network.\\ The route
        was not added as a member to a valid [network
        relation](docs/en.html#glossary-network-relation "network relation in
        glossary").
      </kpn-statistic-configuration>
      ...
      >
        Total length (km) of the orphan routes (not included in network length
        above).
      </kpn-statistic-configuration>
      ...
      >
        Integrity check coverage (percentage of nodes that do have integrity
        check information).
      </kpn-statistic-configuration>
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of routes where one or more of the ways (or part of ways) are not
        used in the forward or backward path or in one of the tentacles.
      </kpn-statistic-configuration>
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of routes for which the end node and/or the begin node is not
        found in any of the ways of the route.
      </kpn-statistic-configuration>
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of routes where the ways of the route contain extra nodes other
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of routes with one or more unexpected node members.\\ In route
        relations we expect only nodes with tag _"rwn_ref"_ or _"rcn_ref"_.
      </kpn-statistic-configuration>
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of routes with one or more unexpected members.\\In route
        relations we expect only members of type _"way"_, or members of type
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of network relation members of type _"node"_ that are unexpected
        (expect only [network nodes](docs/en.html#glossary-node "node in
        glossary") or [information maps](docs/en.html#glossary-info-map
        "information maps in glossary") as members in the network relation).
      </kpn-statistic-configuration>
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of network relation members of type _"way"_ (expect only route
        relations or network nodes as members in the node network relation).
      </kpn-statistic-configuration>
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of network relation members of type _"relation"_ that are
        unexpected (expect only valid route relations or network nodes as
        members in the node network relation).
      </kpn-statistic-configuration>
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Number of [unaccessible](docs/en.html#glossary-accessible "accessible in
        glossary") routes.
      </kpn-statistic-configuration>
      ...
      <kpn-statistic-configuration
        ...
        [linkFunction]="factDetailCounts"
      >
        Routes where the route name does not match with the names of the start
        node and the end node. The route name is expected to contain the start
        node name and the end node name, separated by a dash. The start node is
        expected to have a lower number than the end node.
      </kpn-statistic-configuration>
    </div>
  `,
  styles: [
...
export class StatisticConfigurationsComponent implements AfterViewInit {
  @ViewChildren(StatisticConfigurationComponent)
  children: StatisticConfigurationComponent[];

  readonly networks = (id: string, subset: Subset) =>
    subset.key() + '/networks';
  readonly orphanNodes = (id: string, subset: Subset) =>
    subset.key() + '/orphan-nodes';
  readonly orphanRoutes = (id: string, subset: Subset) =>
    subset.key() + '/orphan-routes';
  readonly factDetailCounts = (id: string, subset: Subset) =>
    subset.key() + '/facts/' + id;
