      ...
      <div class="kpn-level-2-body">
        <div *ngFor="let ref of refs" class="kpn-level-3">
          ...
          <div *ngIf="ref.routeChangeInfo" class="kpn-level-3-body">
            <div *ngIf="ref.routeChangeInfo.after">
              <div class="kpn-thin">
                <ng-container *ngIf="ref.routeChangeInfo.after.changeSetId == data.changeSetId">
                  <ng-container *ngIf="ref.routeChangeInfo.after.version == 1" i18n="@@route-diffs-added.new-relation">
                    New relation
                  </ng-container>
                  <ng-container *ngIf="ref.routeChangeInfo.after.version > 1" i18n="@@route-diffs-added.updated-relation">
            ...
            <kpn-fact-diffs [factDiffs]="ref.routeChangeInfo.diffs.factDiffs"></kpn-fact-diffs>
          </div>
        </div>
      </div>
    </div>
