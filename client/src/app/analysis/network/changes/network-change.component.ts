...
@Component({
  ...
  template: `
    ...
    <!-- networkNodesAdded -->
    <div
      *ngIf="!networkChangeInfo.networkNodes.added.isEmpty()"
      class="kpn-line"
    >
    ...
    <!-- networkNodesUpdated -->
    <div
      *ngIf="!networkChangeInfo.networkNodes.updated.isEmpty()"
      class="kpn-line"
    >
    ...
    <!-- networkNodesRemoved -->
    <div
      *ngIf="!networkChangeInfo.networkNodes.removed.isEmpty()"
      class="kpn-line"
    >
