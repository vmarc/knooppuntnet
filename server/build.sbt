...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      ("org.springframework.boot" % "spring-boot-starter-web" % springBootVersion).exclude("org.springframework.boot", "spring-boot-starter-logging"),
      ...
      ("org.geotools" % "gt-api" % geoToolsVersion).exclude("javax.media", "jai_core"),
      ("org.geotools" % "gt-referencing" % geoToolsVersion).exclude("javax.media", "jai_core"),
      ("org.geotools" % "gt-geojson-store" % geoToolsVersion).exclude("javax.media", "jai_core") classifier "sources",
      ("org.geotools" % "gt-epsg-hsql" % geoToolsVersion).exclude("javax.media", "jai_core"),

      // GeoPackage
      ("mil.nga.geopackage" % "geopackage" % "6.6.5").exclude("org.slf4j", "slf4j-nop"),
