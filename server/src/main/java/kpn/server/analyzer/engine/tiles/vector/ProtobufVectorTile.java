...
public interface ProtobufVectorTile {
	...
	public static final class Tile extends
		...
		public static final class Feature extends
			...
			public Feature clearType() {
				type_ = ProtobufVectorTile.Tile.UNKNOWN;
				bitField0_ = (bitField0_ & ~0x00000002);
				return this;
			}
				...
				while (true) {
					...
					switch (tag) {
						...
						case 24: {
							...
							switch (value) {
								case ProtobufVectorTile.Tile.UNKNOWN:
								case ProtobufVectorTile.Tile.POINT:
								case ProtobufVectorTile.Tile.LINESTRING:
								case ProtobufVectorTile.Tile.POLYGON:
									type_ = value;
									bitField0_ |= 0x00000002;
									break;
							}
		...
		public static final class Layer extends
			...
			public ProtobufVectorTile.Tile.Feature[] features;

			// repeated string keys = 3;
			public java.lang.String[] keys;

			// repeated .vector_tile.Tile.Value values = 4;
			public ProtobufVectorTile.Tile.Value[] values;
			...
			public Layer clear() {
				...
				version = 1;
				name = "";
				features = ProtobufVectorTile.Tile.Feature.emptyArray();
				keys = com.google.protobuf.nano.WireFormatNano.EMPTY_STRING_ARRAY;
				values = ProtobufVectorTile.Tile.Value.emptyArray();
				extent_ = 4096;
				unknownFieldData = null;
				cachedSize = -1;
				return this;
			...
			public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
				...
				if (this.features != null && this.features.length > 0) {
					for (int i = 0; i < this.features.length; i++) {
						ProtobufVectorTile.Tile.Feature element = this.features[i];
						if (element != null) {
				...
				if (this.values != null && this.values.length > 0) {
					for (int i = 0; i < this.values.length; i++) {
						ProtobufVectorTile.Tile.Value element = this.values[i];
						if (element != null) {
				...
				while (true) {
					...
					switch (tag) {
						...
						case 18: {
							...
							ProtobufVectorTile.Tile.Feature[] newArray =
									new ProtobufVectorTile.Tile.Feature[i + arrayLength];
							if (i != 0) {
								java.lang.System.arraycopy(this.features, 0, newArray, 0, i);
							}
							for (; i < newArray.length - 1; i++) {
								newArray[i] = new ProtobufVectorTile.Tile.Feature();
						...
						case 34: {
							...
							ProtobufVectorTile.Tile.Value[] newArray =
									new ProtobufVectorTile.Tile.Value[i + arrayLength];
							if (i != 0) {
								java.lang.System.arraycopy(this.values, 0, newArray, 0, i);
							}
							for (; i < newArray.length - 1; i++) {
								newArray[i] = new ProtobufVectorTile.Tile.Value();
								input.readMessage(newArray[i]);
								input.readTag();
							}
							// Last one without readTag.
		...
		public ProtobufVectorTile.Tile.Layer[] layers;
		...
		public Tile clear() {
			layers = ProtobufVectorTile.Tile.Layer.emptyArray();
			unknownFieldData = null;
			cachedSize = -1;
			return this;
		}
		...
		public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
			...
			if (this.layers != null && this.layers.length > 0) {
				for (int i = 0; i < this.layers.length; i++) {
					ProtobufVectorTile.Tile.Layer element = this.layers[i];
					if (element != null) {
			...
			while (true) {
				...
				switch (tag) {
					...
					case 26: {
						...
						ProtobufVectorTile.Tile.Layer[] newArray =
								new ProtobufVectorTile.Tile.Layer[i + arrayLength];
						if (i != 0) {
							java.lang.System.arraycopy(this.layers, 0, newArray, 0, i);
						}
						for (; i < newArray.length - 1; i++) {
							newArray[i] = new ProtobufVectorTile.Tile.Layer();
							input.readMessage(newArray[i]);
							input.readTag();
						}
						// Last one without readTag.
