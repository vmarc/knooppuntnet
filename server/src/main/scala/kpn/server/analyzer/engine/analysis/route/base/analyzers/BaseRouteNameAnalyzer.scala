 ...
 * </ol>
 */
object BaseRouteNameAnalyzer extends BaseRouteAnalyzer {
  def analyze(context: BaseRouteAnalysisContext): BaseRouteAnalysisContext = {
    new BaseRouteNameAnalyzer(context).analyze
  }
}

class BaseRouteNameAnalyzer(context: BaseRouteAnalysisContext) {
