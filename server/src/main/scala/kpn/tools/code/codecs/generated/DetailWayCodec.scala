...
class DetailWayCodec(registry: CodecRegistry) extends Codec[DetailWay] {
  ...
  override def decode(bsonReader: BsonReader, decoderContext: DecoderContext): DetailWay = {
    ...
    while (bsonReader.readBsonType != BsonType.END_OF_DOCUMENT) {
      ...
      if (fieldName == "id") {
        ...
        Codecs.warn(s"Unknown field name: $fieldName in DetailWayCodec.decode()")
  ...
  override def encode(bsonWriter: BsonWriter, value: DetailWay, encoderContext: EncoderContext): Unit = {
  ...
  override def getEncoderClass: Class[DetailWay] = {
    classOf[DetailWay]
  }
}
