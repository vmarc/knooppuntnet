...
class NetworkNodeDetailCodec(registry: CodecRegistry) extends Codec[NetworkNodeDetail] {
  ...
  override def decode(bsonReader: BsonReader, decoderContext: DecoderContext): NetworkNodeDetail = {
    ...
    while (bsonReader.readBsonType != BsonType.END_OF_DOCUMENT) {
      ...
      if (fieldName == "id") {
        ...
        Codecs.log.warn(s"Unknown field name: $fieldName in NetworkNodeDetailCodec.decode()")
  ...
  override def encode(bsonWriter: BsonWriter, value: NetworkNodeDetail, encoderContext: EncoderContext): Unit = {
  ...
  override def getEncoderClass: Class[NetworkNodeDetail] = {
    classOf[NetworkNodeDetail]
  }
}
