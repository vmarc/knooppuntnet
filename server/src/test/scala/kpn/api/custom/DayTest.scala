...
class DayTest extends UnitTest {
  ...
  test("fromString") {
    ...
    Day.fromString("2020-08-11") should equal(Some(Day(2020, 8, Some(11))))
    Day.fromString("2020-08") should equal(Some(Day(2020, 8, None)))
  ...
  test("yyyymmdd") {
    Day(2020, 8, Some(11)).yyyymmdd should equal("2020-08-11")
