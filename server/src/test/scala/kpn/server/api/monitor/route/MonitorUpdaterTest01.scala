...
class MonitorUpdaterTest01 extends UnitTest with SharedTestObjects with MockFactory {
  ...
  test("add simple route with osm reference") {
    ...
    withDatabase() { database =>
      ...
      route.osmSegmentCount should equal(0L) // TODO
      route.happy should equal(false) // TODO

      // TODO route.relation should equal(None)
