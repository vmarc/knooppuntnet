...
// multiple tentacles stacked at end
class Structure_N07_Test extends UnitTest {
  ...
  test("analyze") {
    ...
    context.segments.shouldMatchTo(
      Seq(
        ...
        "  element-3 bidirectional 7>9  7(02)  9(02)",
