...
class Issue150_RoutingAgainstOneWayDirectionTest extends UnitTest {
  ...
  test("bicyle routing against one-way direction") {
    ...
    withDatabase { database =>
      ...
      //      val route1forwardPath = route1.routeDetail.analysis.map.forwardPath.get
      //      val route2forwardPath = route2.routeDetail.analysis.map.forwardPath.get
      //      val route2startTentablePath1 = route2.routeDetail.analysis.map.startTentaclePaths.head
      //
      ...
      //      segment1a.pathKey.routeId should equal(route1.id)
      ...
      //      segment1b.pathKey.routeId should equal(route1.id)
