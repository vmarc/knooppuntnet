...
class QueryParametersTest extends UnitTest {
  ...
  test("default items per page - page 1") {
    ...
    QueryParameters.parametersFrom(parameters)("skip") should equal("0")
  }

  test("default items per page - page 2") {
    val parameters = ChangesParameters(pageIndex = 1)
    QueryParameters.parametersFrom(parameters)("skip") should equal("5")
  }

  test("default items per page - page 3") {
    val parameters = ChangesParameters(pageIndex = 2)
    QueryParameters.parametersFrom(parameters)("skip") should equal("10")
  }
  ...
  test("10 items per page - page 3") {
    ...
    QueryParameters.parametersFrom(parameters)("skip") should equal("20")
  }

  test("network all") {
    val parameters = ChangesParameters()
    val queryParameters = QueryParameters.networkParametersFrom(123L, parameters)
  ...
  test("network impacted") {
    val parameters = ChangesParameters(impact = true)
    val queryParameters = QueryParameters.networkParametersFrom(123L, parameters)
  ...
  test("route all") {
    val parameters = ChangesParameters()
    val queryParameters = QueryParameters.routeParametersFrom(123L, parameters)
  ...
  test("node all") {
    val parameters = ChangesParameters()
    val queryParameters = QueryParameters.nodeParametersFrom(123L, parameters)
