...
class WayInfoCodec(registry: CodecRegistry) extends Codec[WayInfo] {
  ...
  override def decode(bsonReader: BsonReader, decoderContext: DecoderContext): WayInfo = {
  ...
  override def encode(bsonWriter: BsonWriter, value: WayInfo, encoderContext: EncoderContext): Unit = {
  ...
  override def getEncoderClass: Class[WayInfo] = {
    classOf[WayInfo]
  }
}
