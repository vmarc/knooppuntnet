      ...
      <.table(
        ...
        <.tbody(
          TagMod(
            ...
            infoRow(infos.nodeNetwerkTypeNotTaggedInfo),
            infoRow(infos.routeNetwerkTypeNotTaggedInfo),
            infoRow(infos.netwerkTypeNotTaggedInfo),
    ...
    private def header(): VdomElement = {
      <.thead(
        <.tr(
          ...
          headerCellCountry(3, nls("Germany", "Duitsland")),
