// Migrated to Angular: page.service.ts
package kpn.client
  ...
  def title(goto: Goto): String = {
    ...
    def buildSubsetTitle(page: GotoSubsetPage, enString: String, nlString: String): String = {
      val part1 = page.subset match {
        ...
        case Subset.frHiking => nls("Hiking in France", "Wandelen in Frankrijk")
        ...
        case Subset.frHorseRiding => nls("Horse riding in France", "Ruiter in Frankrijk")
