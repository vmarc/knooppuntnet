...
export interface NodeChangeInfo {
  ...
  readonly changeTags: ReadonlyArray<Tag>;
  readonly comment?: string;
  readonly before?: MetaData;
  readonly after?: MetaData;
  readonly connectionChanges: ReadonlyArray<RefBooleanChange>;
  readonly roleConnectionChanges: ReadonlyArray<RefBooleanChange>;
  readonly definedInNetworkChanges: ReadonlyArray<RefBooleanChange>;
  readonly tagDiffs?: TagDiffs;
  readonly nodeMoved?: NodeMoved;
  readonly addedToRoute: ReadonlyArray<Ref>;
  readonly removedFromRoute: ReadonlyArray<Ref>;
  readonly addedToNetwork: ReadonlyArray<Ref>;
  readonly removedFromNetwork: ReadonlyArray<Ref>;
  readonly factDiffs?: FactDiffs;
  readonly facts: ReadonlyArray<Fact>;
  readonly initialTags?: ReadonlyArray<Tag>;
