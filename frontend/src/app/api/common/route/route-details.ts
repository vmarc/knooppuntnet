...
export interface RouteDetails {
  ...
  readonly unexpectedNodeIds: ReadonlyArray<number>;
  readonly unexpectedRelationIds: ReadonlyArray<number>;
  ...
  readonly parentRoutes: ReadonlyArray<ParentRoute>;
  readonly networkReferences: ReadonlyArray<Reference>;
  readonly locationCandidateInfos: ReadonlyArray<LocationCandidateInfo>;
}
