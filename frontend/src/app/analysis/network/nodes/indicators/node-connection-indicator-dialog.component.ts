...
@Component({
  ...
  template: `
    ...
    >
      ...
      <markdown dialog-body *ngIf="isBlue()" i18n="@@node-connection-indicator.blue.text">
      ...
      <markdown dialog-body *ngIf="isGray()" i18n="@@node-connection-indicator.gray.text">
        This node is not a connection to another network. The node would have been considered as a
        connection to another network if all routes to this node within the network had role
        *"connection"* in the network relation.
      </markdown>
    </kpn-indicator-dialog>
  `,
