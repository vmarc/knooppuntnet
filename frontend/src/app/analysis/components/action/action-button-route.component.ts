...
@Component({
  selector: 'ui-action-button-route',
  ...
  template: `
    ...
    <nz-dropdown-menu #menu="nzDropdownMenu">
      <ul nz-menu>
        ...
        <ui-action-menu-item (action)="josmZoom()">JOSM zoom/pan to route</ui-action-menu-item>
        ...
        @if (routeType()) {
          <li nz-menu-divider></li>
          <ui-action-menu-item (action)="waymarkedTrails()">Waymarked Trails</ui-action-menu-item>
        }
      </ul>
    </nz-dropdown-menu>
  `,
