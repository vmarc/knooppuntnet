...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div
        dialog-body
        *ngIf="isGreen() && isCycling()"
        i18n="@@route-accessible-indicator.green.text.cycling"
      >
      ...
      <div
        dialog-body
        *ngIf="isGreen() && isHiking()"
        i18n="@@route-accessible-indicator.green.text.hiking"
      >
      ...
      <div
        dialog-body
        *ngIf="isGreen() && isMotorboat()"
        i18n="@@route-accessible-indicator.green.text.motorboat"
      >
      ...
      <div
        dialog-body
        *ngIf="isGreen() && isCanoe()"
        i18n="@@route-accessible-indicator.green.text.canoe"
      >
      ...
      <div
        dialog-body
        *ngIf="isRed() && isCycling()"
        i18n="@@route-accessible-indicator.red.text.cycling"
      >
      ...
      <div
        dialog-body
        *ngIf="isRed() && isHiking()"
        i18n="@@route-accessible-indicator.red.text.hiking"
      >
      ...
      <div
        dialog-body
        *ngIf="isRed() && isMotorboat()"
        i18n="@@route-accessible-indicator.red.text.motorboat"
      >
      ...
      <div
        dialog-body
        *ngIf="isRed() && isCanoe()"
        i18n="@@route-accessible-indicator.red.text.canoe"
      >
